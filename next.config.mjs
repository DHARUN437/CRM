...
const nextConfig = {
  ...
  // Security headers (applied to every response served by the Next server).
  async headers() {
    return [
      {
        source: "/:path*",
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://www.googleapis.com https://accounts.google.com https://drive.google.com https://docs.google.com",
