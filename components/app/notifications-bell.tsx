    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          />
          <div className="absolute right-0 top-11 z-50 w-80 sm:w-96 rounded-xl border border-border bg-popover p-4 shadow-xl text-popover-foreground animate-in fade-in-0 zoom-in-95">
