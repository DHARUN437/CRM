...
import { ProjectStatusTimeline } from "@/components/portal/project-status-timeline"
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Where your project stands</CardTitle>
          </CardHeader>
          <CardContent>
            <ProjectStatusTimeline status={project.status as ProjectStatus} />
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        ...
        <section className="flex flex-col gap-3">
          ...
          <ChatThread
            ...
            currentName={client.company ?? client.name}
            currentRole="client"
          />
        </section>
