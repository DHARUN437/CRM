      ...
      {!documents?.length ? (
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {documents.map((doc, index) => (
            <Card key={doc.id} className="group relative flex flex-col justify-between overflow-hidden rounded-3xl border border-white/50 bg-white/60 p-5 shadow-sm backdrop-blur-xl transition-all hover:-translate-y-1 hover:shadow-layered glass-card-hover min-h-[160px]">
